...
- **Vídeo:** identificação e player entram em uma sequência curta, preservando o protagonismo do conteúdo incorporado.
- **Fechamento:** ornamento, kicker, título, texto e formulário de contato encerram a página em progressão silenciosa.
- **Acervo de artigos:** hero, filtros, linhas e paginação respondem por `transform`, cor e opacidade, sem deslocar o layout.
